      ...
      if (result.verified) {
        ...
        return res.status(200).json({
          ...
          user: {
            ...
            id: user.id,
            // callback: `exampleauth:////auth?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwi
            // aWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf677tftgjgnnt6u6i76ghggffhght6665675435634655gfgfgft636POk6yJV_adQssw5c`,
